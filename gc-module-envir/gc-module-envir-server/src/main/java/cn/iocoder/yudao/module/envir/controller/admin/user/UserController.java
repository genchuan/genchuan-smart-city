package cn.iocoder.yudao.module.envir.controller.admin.user;
...
import cn.iocoder.yudao.module.envir.service.user.UserService;

@Tag(name = "管理后台 - 系统用户")
@RestController
@RequestMapping("/envir/user")
@Validated
public class UserController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:user:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:user:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:user:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:user:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:user:export')")
    ...
    @Operation(summary = "获取系统用户列表(详情)")
    @PreAuthorize("@ss.hasPermission('envir:user:query')")
    public CommonResult<List<UserDetailDO>> getUserListDetail() {
        List<UserDetailDO> list = userService.getUserListDetail();
        return success(list);
    }
}