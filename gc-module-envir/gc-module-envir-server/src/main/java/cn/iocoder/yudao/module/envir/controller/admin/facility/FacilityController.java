package cn.iocoder.yudao.module.envir.controller.admin.facility;
...
import cn.iocoder.yudao.module.envir.service.facility.FacilityService;

@Tag(name = "管理后台 - 设施字典")
@RestController
@RequestMapping("/envir/facility")
@Validated
public class FacilityController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:facility:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:facility:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:facility:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:facility:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:facility:export')")
