package cn.iocoder.yudao.module.envir.controller.admin.tool;
...
import cn.iocoder.yudao.module.envir.controller.admin.tool.vo.*;
import cn.iocoder.yudao.module.envir.dal.dataobject.tool.ToolDO;
import cn.iocoder.yudao.module.envir.service.tool.ToolService;

@Tag(name = "管理后台 - 工具字典")
@RestController
@RequestMapping("/envir/tool")
@Validated
public class ToolController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:tool:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:tool:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:tool:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:tool:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:tool:export')")
