package cn.iocoder.yudao.module.envir.controller.admin.area;
...
import cn.iocoder.yudao.module.envir.service.area.AreaService;

@Tag(name = "管理后台 - 区域编码")
@RestController
@RequestMapping("/envir/area")
@Validated
public class AreaController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:area:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:area:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:area:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:area:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:area:export')")
