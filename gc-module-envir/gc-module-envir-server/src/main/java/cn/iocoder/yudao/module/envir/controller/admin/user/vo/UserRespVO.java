...
public class UserRespVO {
    ...
    @ExcelProperty("平均考核得分（保留2位小数）")
    private BigDecimal averageScore;

    @Schema(description = "最近作业轨迹（JSON格式）")
    @ExcelProperty("最近作业轨迹（JSON格式）")
