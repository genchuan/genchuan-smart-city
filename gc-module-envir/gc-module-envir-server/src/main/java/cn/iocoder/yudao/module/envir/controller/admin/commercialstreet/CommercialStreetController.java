package cn.iocoder.yudao.module.envir.controller.admin.commercialstreet;
...
import cn.iocoder.yudao.module.envir.service.commercialstreet.CommercialStreetService;

@Tag(name = "管理后台 - 商业街")
@RestController
@RequestMapping("/envir/commercial-street")
@Validated
public class CommercialStreetController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:commercial-street:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:commercial-street:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:commercial-street:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:commercial-street:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:commercial-street:export')")
    ...
    @Operation(summary = "获得商业街列表(详情)")
    @PreAuthorize("@ss.hasPermission('envir:commercial-street:query')")
    public CommonResult<List<CommercialStreetDetailDO>> getCommercialStreetListDetail() {
        List<CommercialStreetDetailDO> list = commercialStreetService.getCommercialStreetListDetail();
        return success(list);
    }
}