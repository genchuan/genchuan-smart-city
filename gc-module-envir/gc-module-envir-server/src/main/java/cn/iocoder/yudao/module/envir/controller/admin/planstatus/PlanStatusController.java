package cn.iocoder.yudao.module.envir.controller.admin.planstatus;
...
import cn.iocoder.yudao.module.envir.service.planstatus.PlanStatusService;

@Tag(name = "管理后台 - 计划状态字典")
@RestController
@RequestMapping("/envir/plan-status")
@Validated
public class PlanStatusController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:plan-status:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:plan-status:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:plan-status:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:plan-status:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:plan-status:export')")
