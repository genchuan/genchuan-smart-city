package cn.iocoder.yudao.module.envir.controller.admin.institutiontype;
...
import cn.iocoder.yudao.module.envir.service.institutiontype.InstitutionTypeService;

@Tag(name = "管理后台 - 机构类型字典")
@RestController
@RequestMapping("/envir/institution-type")
@Validated
public class InstitutionTypeController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:institution-type:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:institution-type:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:institution-type:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:institution-type:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:institution-type:export')")
