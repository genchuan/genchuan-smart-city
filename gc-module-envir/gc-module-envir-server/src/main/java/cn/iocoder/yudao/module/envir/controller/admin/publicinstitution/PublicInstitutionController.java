package cn.iocoder.yudao.module.envir.controller.admin.publicinstitution;
...
import cn.iocoder.yudao.module.envir.service.publicinstitution.PublicInstitutionService;

@Tag(name = "管理后台 - 公共机构")
@RestController
@RequestMapping("/envir/public-institution")
@Validated
public class PublicInstitutionController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:public-institution:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:public-institution:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:public-institution:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:public-institution:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:public-institution:export')")
    ...
    @Operation(summary = "获得公共机构列表(详情)")
    @PreAuthorize("@ss.hasPermission('envir:public-institution:query')")
    public CommonResult<List<PublicInstitutionDetailDO>> getPublicInstitutionListDetail() {
        List<PublicInstitutionDetailDO> list = publicInstitutionService.getPublicInstitutionListDetail();
        return success(list);
    }
}