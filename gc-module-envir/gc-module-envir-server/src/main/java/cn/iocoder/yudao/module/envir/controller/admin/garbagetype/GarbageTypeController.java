package cn.iocoder.yudao.module.envir.controller.admin.garbagetype;
...
import cn.iocoder.yudao.module.envir.service.garbagetype.GarbageTypeService;

@Tag(name = "管理后台 - 垃圾品类字典")
@RestController
@RequestMapping("/envir/garbage-type")
@Validated
public class GarbageTypeController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:garbage-type:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:garbage-type:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:garbage-type:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:garbage-type:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:garbage-type:export')")
