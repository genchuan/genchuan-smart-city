package cn.iocoder.yudao.module.envir.controller.admin.vehiclestatus;
...
import cn.iocoder.yudao.module.envir.service.vehiclestatus.VehicleStatusService;

@Tag(name = "管理后台 - 车辆状态字典")
@RestController
@RequestMapping("/envir/vehicle-status")
@Validated
public class VehicleStatusController {
    ...
    @PreAuthorize("@ss.hasPermission('envir:vehicle-status:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:vehicle-status:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:vehicle-status:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:vehicle-status:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envir:vehicle-status:export')")
