...
import cn.iocoder.yudao.module.envir.dal.mysql.vehicle.VehicleMapper;
...
public class VehicleServiceImpl implements VehicleService {
    ...
    @Override
    public List<VehicleDetailDO> getVehicleListDetail() {
        return vehicleMapper.selectListDetail();
    }
}