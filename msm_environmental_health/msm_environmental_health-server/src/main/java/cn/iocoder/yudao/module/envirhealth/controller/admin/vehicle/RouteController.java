...
public class RouteController {
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:route:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:route:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:route:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:route:export')")
