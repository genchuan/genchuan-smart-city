...
@Schema(description = "管理后台 - 车辆状态字典 Response VO")
@Data
@ExcelIgnoreUnannotated
public class VehicleStatusRespVO {

    @Schema(description = "主键ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "19967")
    @ExcelProperty("主键ID")
    private Long id;
    ...
    @ExcelProperty("状态名称（可选值：正常运行/维护中/故障/闲置/报废/待年检/停运）")
    private String name;
