...
public class DeptController {
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:dept:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:dept:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:dept:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:dept:export')")
