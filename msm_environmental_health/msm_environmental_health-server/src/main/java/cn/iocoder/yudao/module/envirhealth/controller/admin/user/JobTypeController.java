...
public class JobTypeController {
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:job-type:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:job-type:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:job-type:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:job-type:query')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:job-type:export')")
