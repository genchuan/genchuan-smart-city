...
@Schema(description = "管理后台 - 评价结果公示 Response VO")
@Data
@ExcelIgnoreUnannotated
public class PublicRecordRespVO {
    ...
    @ExcelProperty("公示状态（关联sys_public_status.status_id）")
    private String status;

    @Schema(description = "公示创建人（关联sys_user.user_id）")
    @ExcelProperty("公示创建人（关联sys_user.user_id）")
