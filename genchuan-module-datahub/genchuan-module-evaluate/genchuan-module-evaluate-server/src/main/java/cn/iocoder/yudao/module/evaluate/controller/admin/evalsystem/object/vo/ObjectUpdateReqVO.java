...
@Schema(description = "管理后台 - 评价对象更新 Request VO")
@Data
public class ObjectUpdateReqVO {

    @Schema(description = "评价对象ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "obj_123")
    @NotBlank(message = "评价对象ID不能为空")
