...
public class PersonStatusController {
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:person-status:create')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:person-status:update')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:person-status:delete')")
    ...
    @PreAuthorize("@ss.hasPermission('envirhealth:person-status:export')")
