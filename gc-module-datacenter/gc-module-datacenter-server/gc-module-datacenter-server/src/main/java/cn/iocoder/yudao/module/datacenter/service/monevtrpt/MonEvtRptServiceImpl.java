...
import cn.iocoder.yudao.module.datacenter.dal.mysql.monevtrpt.MonEvtRptMapper;
...
public class MonEvtRptServiceImpl implements MonEvtRptService {
    ...
    @Override
    public String createMonEvtRpt(MonEvtRptSaveReqVO createReqVO) {
        // 插入
    ...
    @Override
    public void deleteMonEvtRpt(String id) {
        // 校验存在
    ...
    private void validateMonEvtRptExists(String id) {
    ...
    @Override
    public MonEvtRptDO getMonEvtRpt(String id) {
