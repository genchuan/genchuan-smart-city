package cn.iocoder.yudao.module.datacenter.controller.admin.monevtrpt;
...
import cn.iocoder.yudao.module.datacenter.service.monevtrpt.MonEvtRptService;
...
public class MonEvtRptController {
    ...
    public CommonResult<String> createMonEvtRpt(@Valid @RequestBody MonEvtRptSaveReqVO createReqVO) {
    ...
    public CommonResult<Boolean> deleteMonEvtRpt(@RequestParam("id") String id) {
    ...
    public CommonResult<MonEvtRptRespVO> getMonEvtRpt(@RequestParam("id") String id) {
