package cn.iocoder.yudao.module.datacenter.controller.admin.inspection.report.inspectproblemrpt;
...
import cn.iocoder.yudao.module.datacenter.controller.admin.inspection.report.inspectproblemrpt.vo.InspectProblemRptRespVO;
...
import cn.iocoder.yudao.module.datacenter.service.inspection.report.inspectproblemrpt.InspectProblemRptService;
...
public class InspectProblemRptController {
    ...
    public void exportInspectProblemRptExcel(@Valid InspectProblemRptPageReqVO pageReqVO,
        ...
        // 导出 Excel
        ExcelUtils.write(response, "巡查巡检问题上报记录.xls", "数据", InspectProblemRptRespVO.class,
