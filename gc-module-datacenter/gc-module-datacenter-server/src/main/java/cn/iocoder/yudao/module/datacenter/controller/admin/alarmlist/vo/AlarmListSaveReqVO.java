...
@Schema(description = "管理后台 - 预警告警列新增/修改 Request VO")
@Data
public class AlarmListSaveReqVO {
    ...
    @NotEmpty(message = "预警等级（一般/较大/重大/特别重大）不能为空")
    ...
    @NotEmpty(message = "预警状态（待处置/处置中/已完成/已解除）不能为空")
