...
@Schema(description = "管理后台 - 充停地图查询结果(快照) Response VO")
@Data
public class ChargeParkMapResultRespVO {

    @Schema(description = "结果ID")
    private Long id;

    @Schema(description = "关联 charge_park_map.id")
    private Long chargeParkMapId;

    @Schema(description = "场站ID")
    private Long stationId;

    @Schema(description = "场站名称(快照)")
