package cn.iocoder.yudao.module.chargepark.carservice.framework.jackson;
 ...
 *
 * 用途:yudao 全局默认把 JSON 的 LocalDateTime 当成**毫秒时间戳**反序列化,
 * 但客户文档要求字符串格式(如 "2026-04-01 00:00:00")。
