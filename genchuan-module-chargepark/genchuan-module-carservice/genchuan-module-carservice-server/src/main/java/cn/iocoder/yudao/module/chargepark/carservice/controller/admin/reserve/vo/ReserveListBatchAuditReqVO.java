...
@Schema(description = "管理后台 - 预约批量审核 Request VO")
@Data
public class ReserveListBatchAuditReqVO {

    /** 文档字典值:"通过" 或 "驳回" */
    public static final String AUDIT_RESULT_PASS = "通过";
    public static final String AUDIT_RESULT_REJECT = "驳回";

    @Schema(description = "预约记录 ID 数组,仅支持待审核状态", requiredMode = Schema.RequiredMode.REQUIRED)
