...
@Schema(description = "管理后台 - 离场记录补录 Request VO")
@Data
public class LeaveRecordCreateReqVO {

    @Schema(description = "车牌", requiredMode = Schema.RequiredMode.REQUIRED, example = "闽 C54321")
    ...
    @Schema(description = "备注", example = "补录离场记录")
    private String remark;

    @Schema(description = "佐证图片地址", example = "/genchuan/chargePark/vehiclePass/leaveMgmt/leaveRecord/2025/04/13/789012.jpg")
