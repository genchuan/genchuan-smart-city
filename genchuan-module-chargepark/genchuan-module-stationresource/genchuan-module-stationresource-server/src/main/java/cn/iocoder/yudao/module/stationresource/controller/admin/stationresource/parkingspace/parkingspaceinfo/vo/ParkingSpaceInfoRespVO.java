...
public class ParkingSpaceInfoRespVO {
    ...
    @ExcelProperty("[车位类型] 如：普通车位/充电车位，关联芋道字典表：parking_space_info_type")
    private String type;

    @Schema(description = "[设备类型] 如：地锁/充电桩/摄像头，关联芋道字典表：parking_space_info_device_type", example = "1")
    @ExcelProperty("[设备类型] 如：地锁/充电桩/摄像头，关联芋道字典表：parking_space_info_device_type")
    private String deviceType;

    @Schema(description = "[车位二维码] VARCHAR(255)")
    @ExcelProperty("[车位二维码] VARCHAR(255)")
    ...
    @ExcelProperty("[状态] 如：未绑定/已绑定/已禁用，关联芋道字典表：parking_space_info_status")
