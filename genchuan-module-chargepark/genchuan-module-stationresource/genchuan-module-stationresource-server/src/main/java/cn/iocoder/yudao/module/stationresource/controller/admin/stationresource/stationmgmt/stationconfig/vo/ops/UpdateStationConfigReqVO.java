package cn.iocoder.yudao.module.stationresource.controller.admin.stationresource.stationmgmt.stationconfig.vo.ops;
...
@Schema(description = "管理后台 - 场站配置新增/修改 Request VO")
@Data
public class UpdateStationConfigReqVO {
...
//    @NotNull(message = "[所属场站] 关联场站信息表 station_info.id不能为空")
