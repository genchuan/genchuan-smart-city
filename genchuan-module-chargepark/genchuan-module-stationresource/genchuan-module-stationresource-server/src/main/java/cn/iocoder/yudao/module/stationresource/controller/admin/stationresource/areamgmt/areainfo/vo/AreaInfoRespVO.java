...
public class AreaInfoRespVO {
    ...
    @Schema(description = "[主键ID]", requiredMode = Schema.RequiredMode.REQUIRED, example = "16304")
    @ExcelProperty("[主键ID]")
    private Long id;

    @Schema(description = "[片区编号]", requiredMode = Schema.RequiredMode.REQUIRED)
    @ExcelProperty("[片区编号]")
...
//    private String city;
    ...
    @Schema(description = "[所属行政区划] 所属行政区划", requiredMode = Schema.RequiredMode.REQUIRED)
