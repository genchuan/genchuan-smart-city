...
@Schema(description = "管理后台 - 汽车充电订单新增/修改 Request VO")
@Data
public class CarChargeOrderSaveReqVO {
    ...
    @Schema(description = "充电功率（kw）", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
