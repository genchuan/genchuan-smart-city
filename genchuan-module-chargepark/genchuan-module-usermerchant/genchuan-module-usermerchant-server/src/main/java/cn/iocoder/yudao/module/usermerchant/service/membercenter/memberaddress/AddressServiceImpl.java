package cn.iocoder.yudao.module.usermerchant.service.membercenter.memberaddress;
...
import cn.iocoder.yudao.module.usermerchant.dal.mysql.membercenter.memberaddress.MemberAddressMapper;
import cn.iocoder.yudao.module.usermerchant.service.membercenter.memberaddress.AddressService;
...
import static cn.iocoder.yudao.module.usermerchant.enums.ErrorCodeConstants.ADDRESS_NOT_EXISTS;
...
public class AddressServiceImpl implements AddressService {
    ...
    private void validAddressExists(Long userId, Long id) {
        ...
        if (addressDO == null) {
            throw new ServiceException(ADDRESS_NOT_EXISTS);
        }
    }
