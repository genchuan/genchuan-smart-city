...
public class MerchantSendCouponExportRespVO {

    @Schema(description = "主键ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "11496")
    @ExcelProperty("主键ID")
    private Long id;

    @Schema(description = "优惠券ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "1926")
    @ExcelProperty("优惠券ID")
    ...
    @Schema(description = "发券状态", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @ExcelProperty("发券状态")
