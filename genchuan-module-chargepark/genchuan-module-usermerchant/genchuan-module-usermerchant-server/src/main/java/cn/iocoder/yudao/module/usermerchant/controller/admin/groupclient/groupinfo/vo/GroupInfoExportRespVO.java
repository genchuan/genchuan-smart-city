...
public class GroupInfoExportRespVO {

    @Schema(description = "主键ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "16794")
    @ExcelProperty("主键ID")
    private Long id;

    @Schema(description = "集团名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "张三")
    @ExcelProperty("集团名称")
    private String name;
    ...
    @Schema(description = "集团类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "2")
    @ExcelProperty("集团类型")
    ...
    @Schema(description = "集团状态", requiredMode = Schema.RequiredMode.REQUIRED, example = "2")
    @ExcelProperty("集团状态")
    ...
    @Schema(description = "审核人ID", example = "29669")
    @ExcelProperty("审核人ID")
