package cn.iocoder.yudao.module.usermerchant.service.membercenter.membersignin;
...
import cn.iocoder.yudao.module.usermerchant.controller.app.membercenter.membersignin.vo.record.AppMemberSignInRecordSummaryRespVO;
import cn.iocoder.yudao.module.usermerchant.convert.membercenter.membersignin.MemberSignInRecordConvert;
...
import cn.iocoder.yudao.module.usermerchant.dal.mysql.membercenter.membersignin.MemberSignInRecordMapper;
import cn.iocoder.yudao.module.usermerchant.enums.*;
...
import static cn.iocoder.yudao.module.usermerchant.enums.ErrorCodeConstants.SIGN_IN_RECORD_TODAY_EXISTS;
...
public class MemberSignInRecordServiceImpl implements MemberSignInRecordService {
    ...
    private void validateSigned(MemberSignInRecordDO signInRecordDO) {
        ...
        if (DateUtils.isToday(signInRecordDO.getCreateTime())) {
            throw new ServiceException(SIGN_IN_RECORD_TODAY_EXISTS);
        }
    }
