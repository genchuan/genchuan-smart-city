package cn.iocoder.yudao.module.enterprisesvc.framework.file;


import cn.iocoder.yudao.module.enterprisesvc.framework.file.config.MinioConfig;
...
public class FileUploadService {
    ...
    private static final String ENTERPRISE_FILE_DIR = "industrialPark/enterpriseSvc/enterpriseFile";
...
//        return minioProperties.getPublicEndpoint() + "/" + minioProperties.getBucket() + "/" + fileName;
    ...
    public String uploadEnterpriseFile(MultipartFile file) throws Exception {
        String objectName = ENTERPRISE_FILE_DIR + "/" + LocalDate.now().format(DATE_PATH_FORMATTER)
