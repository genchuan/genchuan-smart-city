...
-- ----------------------------
INSERT INTO system_dict_type (name, type, status, remark, creator, create_time, updater, update_time, deleted)
VALUES ('德育资源状态', 'moral_resource_status', 0, '德育资源的上架状态', 'admin', NOW(), 'admin', NOW(), 0);
...
INSERT INTO system_dict_data (sort, label, value, dict_type, status, color_type, css_class, remark, creator, create_time, updater, update_time, deleted)
VALUES
    (1, '未上架', 'offline', 'moral_resource_status', 0, 'warning', '', '资源未上架，用户不可见', 'admin', NOW(), 'admin', NOW(), 0),
    (2, '已上架', 'online', 'moral_resource_status', 0, 'success', '', '资源已上架，用户可见可用', 'admin', NOW(), 'admin', NOW(), 0);

-- ----------------------------
-- 德育资源类型 - 字典类型
-- ----------------------------
INSERT INTO system_dict_type (name, type, status, remark, creator, create_time, updater, update_time, deleted)
VALUES ('德育资源类型', 'moral_resource_resource_type', 0, '德育资源的分类类型', 'admin', NOW(), 'admin', NOW(), 0);
...
INSERT INTO system_dict_data (sort, label, value, dict_type, status, color_type, css_class, remark, creator, create_time, updater, update_time, deleted)
VALUES
    (1, '课程', 'course', 'moral_resource_resource_type', 0, 'primary', '', '德育课程资源', 'admin', NOW(), 'admin', NOW(), 0),
