 ...
 * @author 亘川智城
 */
public interface RoadConfigService {
     ...
     * @return 编号
     */
    Long createRoadConfig(@Valid RoadConfigSaveReqVO createReqVO);
...
//    PageResult<RoadConfigRespVO> getRoadConfigPage(RoadConfigPageReqVO pageReqVO);
     ...
     * @return 道路监测配置分页
     */
    PageResult<RoadConfigDO> getRoadConfigPage(RoadConfigPageReqVO pageReqVO);
