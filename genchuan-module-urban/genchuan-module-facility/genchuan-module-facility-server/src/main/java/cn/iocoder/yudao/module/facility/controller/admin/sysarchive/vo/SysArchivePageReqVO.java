...
public class SysArchivePageReqVO extends PageParam {

    @Schema(description = "[归档编号] 归档唯一编号")
    ...
    @Schema(description = "[设施编码] 关联对应设施表编码")
    private String facilityCode;

    @Schema(description = "[设施名称] 设施名称", example = "张三")
    private String facilityName;

    @Schema(description = "[设施类型] 设施类型", example = "2")
