...
public class ComponentInformationRespVO {
    ...
    @ExcelProperty(value = "部件类型", converter = DictConvert.class)
    @DictFormat("sm_part_type") // TODO 代码优化：建议设置到对应的 DictTypeConstants 枚举类中
    ...
    @ExcelProperty(value = "部件状态", converter = DictConvert.class)
    @DictFormat("sm_state") // TODO 代码优化：建议设置到对应的 DictTypeConstants 枚举类中
