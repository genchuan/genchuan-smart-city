...
public interface ErrorCodeConstants {
    ...
    // ========== 双随机行政检查 1_101_041==========
    ErrorCode INSPECTION_OBJECT_NOT_EXISTS = new ErrorCode(1_101_041, "双随机行政检查不存在");

    // ========== 案件受理 1_101_042 ==========
    ErrorCode CASE_ACCEPTANCE_NOT_EXISTS = new ErrorCode(1_101_042, "案件受理不存在");

    // ========== 案件结案 1_101_043 ==========
    ErrorCode CASE_CLOSURE_NOT_EXISTS = new ErrorCode(1_101_043, "案件结案不存在");

    // ========== 案件处理 1_101_044 ==========
    ErrorCode CASE_DISPOSAL_NOT_EXISTS = new ErrorCode(1_101_044, "案件处理不存在");

    // ========== 案件调查 1_101_045 ==========
    ErrorCode CASE_INVESTIGATION_NOT_EXISTS = new ErrorCode(1_101_045, "案件调查不存在");

    // ========== 执法文书 1_101_046 ==========
    ErrorCode LAW_DOCUMENT_NOT_EXISTS = new ErrorCode(1_101_046, "执法文书不存在");

    // ========== 排水户信息 1_101_047 ==========
    ErrorCode DRAINAGE_USER_NOT_EXISTS = new ErrorCode(1_101_047, "排水户信息不存在");

    // ========== 排水许可证申请 1_101_048 ==========
    ErrorCode DRAINAGE_PERMIT_APPLY_NOT_EXISTS = new ErrorCode(1_101_048, "排水许可证申请不存在");

    // ========== 排水电子许可证信息 1_101_049 ==========
    ErrorCode DRAINAGE_LICENSE_NOT_EXISTS = new ErrorCode(1_101_049, "排水电子许可证信息不存在");
