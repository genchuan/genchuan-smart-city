...
public class RoadController {
     ...
     */
    @GetMapping("/options")
    @Operation(summary = "获得道路名称(下拉框)")
    @PreAuthorize("@ss.hasPermission('health:road:query')")
    public CommonResult<List<OptionVO>> getRoadNameOptions() {
        return success(roadService.getRoadNameOptions());
    }
}
