package cn.iocoder.yudao.module.envirhealth.controller.admin.maintainstatus.vo;
...
@Schema(description = "管理后台 - 维护状态字典表【通用复用】分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class MaintainStatusPageReqVO extends PageParam {
