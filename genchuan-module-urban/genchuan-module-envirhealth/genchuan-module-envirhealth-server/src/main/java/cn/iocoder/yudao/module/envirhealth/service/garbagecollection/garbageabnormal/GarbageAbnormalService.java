...
//     * @param pageReqVO 分页查询
     ...
     * @return 垃圾异常统计数据
     */
    GarbageAbnormalCardRespVO getGarbageAbnormalCardAbnormal();
     ...
     * 批量复核垃圾异常记录
     *
     * @param batchReviewReqVO 批量复核信息
     */
    void batchReviewGarbageAbnormal(@Valid GarbageAbnormalBatchReviewReqVO batchReviewReqVO);

    /**
     * 批量更新垃圾异常记录处置状态
     *
     * @param batchHandleReqVO 批量处置信息
     */
    void batchUpdateHandleStatus(@Valid GarbageAbnormalBatchHandleReqVO batchHandleReqVO);
}