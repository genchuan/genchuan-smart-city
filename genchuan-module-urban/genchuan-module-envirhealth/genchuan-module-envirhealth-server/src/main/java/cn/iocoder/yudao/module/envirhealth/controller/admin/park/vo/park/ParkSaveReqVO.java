...
@Schema(description = "环境卫生管理 - 公园新增/修改 Request VO")
@Data
public class ParkSaveReqVO {
    ...
    public void setGreenTypeIds(String greenTypeIds) {
        this.greenTypeIds = (greenTypeIds == null || greenTypeIds.trim().isEmpty()) ? "[]" : greenTypeIds;
    }

    public void setGreenStaffIds(String greenStaffIds) {
        this.greenStaffIds = (greenStaffIds == null || greenStaffIds.trim().isEmpty()) ? "[]" : greenStaffIds;
    }
    ...
    public void setFacilityPhotoUrl(String facilityPhotoUrl) {
        this.facilityPhotoUrl = (facilityPhotoUrl == null || facilityPhotoUrl.trim().isEmpty()) ? "[]" : facilityPhotoUrl;
    }
}