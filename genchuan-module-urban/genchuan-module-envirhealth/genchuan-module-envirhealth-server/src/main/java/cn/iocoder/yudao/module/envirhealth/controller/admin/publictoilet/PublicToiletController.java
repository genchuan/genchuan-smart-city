...
import cn.iocoder.yudao.module.envirhealth.controller.admin.publictoilet.vo.publictoilet.PublicToiletAllRespVO;
...
public class PublicToiletController {
    ...
    @Operation(summary = "卡片/圆环图/柱状图统计(全部)")
    @PreAuthorize("@ss.hasPermission('health:public-toilet:query')")
    public CommonResult<PublicToiletAllRespVO> getAll() {
        return success(publicToiletService.getAll());
    }
}