<template>
  ...
  <ContentWrap>
    <el-card class="table-card" shadow="never">
      <template #header>
        <div class="card-header">
          <span class="card-title">预案分类配置列表</span>
        ...
        <el-table-column label="操作" align="center" width="140" fixed="right">
          <template #default="scope">
            ...
            <el-button
              ...
              v-hasPermi="['datacenter:emer-plan-cat:query']"
            >
              子类
            </el-button>
          </template>
...
const handleViewChildren = (row: any) => {
  // 这里可以跳转到子类页面或打开子类弹窗
  message.success(`查看 ${row.catName} 的子类`)
  // 实际项目中可以调用子类弹窗组件或跳转
  // childrenRef.value.open(row.planCatId)
}
