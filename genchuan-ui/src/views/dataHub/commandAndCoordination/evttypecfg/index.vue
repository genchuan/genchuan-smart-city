<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column label="类型ID" align="center" prop="evtTypeId" />
      <el-table-column label="父类型ID" align="center" prop="parentTypeId" />
      <el-table-column label="类型层级" align="center" prop="typeLevel" />
      <el-table-column label="类型编码" align="center" prop="typeCode" />
      <el-table-column label="类型名称" align="center" prop="typeName" />
      <el-table-column label="类型说明" align="center" prop="typeDesc" />
      <el-table-column label="所属区域代码" align="center" prop="regionCode" />
      <el-table-column label="所属区域名称" align="center" prop="regionName" />
...
const getList = async () => {
  loading.value = true
  try {
    const data = await EvtTypeCfgApi.getEvtTypeCfgList(queryParams)
    list.value = handleTree(data, 'id', 'parentTypeId')
  } finally {
    loading.value = false
  }
}
