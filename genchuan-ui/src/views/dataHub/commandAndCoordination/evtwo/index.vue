<template>
  ...
  <ContentWrap>
    <el-card class="table-card" shadow="never">
      <template #header>
        <div class="card-header">
          <span class="card-title">事件工单列表</span>
      ...
      >
        <el-table-column label="工单信息" align="center" min-width="200">
          <template #default="scope">
            <div class="wo-info">
              <div class="wo-no">{{ scope.row.woNo }}</div>
              <div class="wo-id">工单ID: {{ scope.row.woId }}</div>
              <div class="evt-code">事件编码: {{ scope.row.evtCode }}</div>
            </div>
          </template>
        </el-table-column>
        <el-table-column label="事件信息" align="center" width="150">
          <template #default="scope">
            <div class="event-info">
              <div class="evt-type">{{ scope.row.evtTypeName }}</div>
            </div>
          </template>
        </el-table-column>
        <el-table-column label="状态" align="center" width="100">
          <template #default="scope">
            <el-tag
              :type="getWoStatusType(scope.row.woStatus)"
              size="small"
            >
              {{ scope.row.woStatus || '未知' }}
            </el-tag>
          </template>
        </el-table-column>
        <el-table-column label="责任信息" align="center" width="180">
          <template #default="scope">
            <div class="responsibility-info">
              <div class="dept-name">{{ scope.row.allocateDeptName }}</div>
              <div class="charger-name">负责人: {{ scope.row.chargerName }}</div>
            </div>
          </template>
        </el-table-column>
          ...
          <template #default="scope">
            ...
            >
              ...
              <div class="detail-fields">
                ...
                <div class="detail-field">
                  <span class="field-label">负责人ID:</span>
                  <span class="field-value">{{ scope.row.chargerId || '无' }}</span>
                </div>
              </div>
            </el-popover>
          </template>
...
/** 获取工单状态标签类型 */
const getWoStatusType = (status: string) => {
