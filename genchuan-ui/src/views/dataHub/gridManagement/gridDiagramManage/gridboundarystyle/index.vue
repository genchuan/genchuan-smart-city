  ...
  <ContentWrap>
    ...
    >
      <el-form-item label="样式ID" prop="styleId">
        <el-input v-model="queryParams.styleId" placeholder="请输入样式ID" clearable @keyup.enter="handleQuery" class="!w-240px" />
      </el-form-item>
      <el-form-item label="比例尺" prop="scale">
        <el-input v-model="queryParams.scale" placeholder="请输入比例尺" clearable @keyup.enter="handleQuery" class="!w-240px" />
      </el-form-item>
      <el-form-item label="网格类型" prop="gridType">
        <el-input v-model="queryParams.gridType" placeholder="请输入网格类型" clearable @keyup.enter="handleQuery" class="!w-240px" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          ...
          <el-button link type="primary" @click="openDetailDrawer(scope.row)">查看</el-button>
...
// GIS 重启事件
const onRestartGis = (row: any) => { ElMessage.info(`GIS 重启事件触发: ${row.id}`) }
