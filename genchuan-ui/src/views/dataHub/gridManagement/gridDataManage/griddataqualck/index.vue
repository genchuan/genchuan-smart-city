  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="整改状态">
        <el-select v-model="queryParams.rectifyStatus" placeholder="全部" clearable class="!w-200px">
...
import { GridDataQualCkApi, GridDataQualCkVO } from '@/api/dataHub/gridManagement/gridDataManage/griddataqualck'
...
const total = ref(0)
const queryParams = reactive({ pageNo:1, pageSize:20, gridType:'', ckItem:'', ckResult:'', rectifyStatus:'' })
...
const rectifyStatusMap = {
  ...
  'PENDING': '待处理',
  'IN_PROGRESS': '整改中' }
const rectifyStatusIcon = { 'PENDING':'ep:warning', 'IN_PROGRESS':'ep:loading', 'COMPLETED':'ep:circle-check' }
...
const resetQuery = () => { Object.assign(queryParams,{ gridType:'', ckItem:'', ckResult:'', rectifyStatus:''}); getList() }
