<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="问题类型代码" prop="questionTypeCode">
        <el-input
          v-model="queryParams.questionTypeCode"
          placeholder="请输入问题类型代码"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="解答方案" prop="answerSolution">
        <el-input
          v-model="queryParams.answerSolution"
          placeholder="请输入解答方案"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
      ...
      <el-form-item label="关联指南ID" prop="relatedGuideId">
        <el-input
          v-model="queryParams.relatedGuideId"
          placeholder="请输入关联指南ID"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="关联指南名称" prop="relatedGuideName">
        <el-input
          v-model="queryParams.relatedGuideName"
          placeholder="请输入关联指南名称"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="FAQ ID" align="center" prop="faqId" />
      <el-table-column label="问题类型代码" align="center" prop="questionTypeCode" />
      <el-table-column label="问题类型名称" align="center" prop="questionTypeName" />
      <el-table-column label="问题描述" align="center" prop="questionDesc" />
      <el-table-column label="解答方案" align="center" prop="answerSolution" />
      <el-table-column label="关联指南ID" align="center" prop="relatedGuideId" />
      <el-table-column label="关联指南名称" align="center" prop="relatedGuideName" />
