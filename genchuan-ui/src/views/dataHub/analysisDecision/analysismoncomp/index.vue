<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="在线部件数" prop="onlineCompCount">
        <el-input
          v-model="queryParams.onlineCompCount"
          placeholder="请输入在线部件数"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="部件总数量" align="center" prop="totalCompCount" />
      <el-table-column label="在线部件数" align="center" prop="onlineCompCount" />
      <el-table-column
        label="系统创建时间"
        align="center"
        prop="createTimeSys"
