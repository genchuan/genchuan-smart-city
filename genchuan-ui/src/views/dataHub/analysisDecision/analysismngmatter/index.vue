<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="事项小类ID" prop="matterMinorId">
        <el-input
          v-model="queryParams.matterMinorId"
          placeholder="请输入事项小类ID"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="事项办结率" prop="matterCompleteRate">
        <el-input
          v-model="queryParams.matterCompleteRate"
          placeholder="请输入事项办结率"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="事项大类ID" align="center" prop="matterMajorId" />
      <el-table-column label="事项大类名称" align="center" prop="matterMajorName" />
      <el-table-column label="事项小类ID" align="center" prop="matterMinorId" />
      <el-table-column label="事项小类名称" align="center" prop="matterMinorName" />
      <el-table-column label="处置部门代码" align="center" prop="deptCode" />
      <el-table-column label="处置部门名称" align="center" prop="deptName" />
      <el-table-column label="事项上报总量" align="center" prop="totalRptCount" />
      <el-table-column label="事项办结率" align="center" prop="matterCompleteRate" />
      <el-table-column
        label="系统创建时间"
        align="center"
        prop="createTimeSys"
