<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="资产大类ID" prop="assetMajorId">
        <el-input
          v-model="queryParams.assetMajorId"
          placeholder="请输入资产大类ID"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="资产小类ID" prop="assetMinorId">
        <el-input
          v-model="queryParams.assetMinorId"
          placeholder="请输入资产小类ID"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="资产总存量" prop="totalAssetCount">
        <el-input
          v-model="queryParams.totalAssetCount"
          placeholder="请输入资产总存量"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="资产完好率" prop="assetIntactRate">
        <el-input
          v-model="queryParams.assetIntactRate"
          placeholder="请输入资产完好率"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="资产总存量" align="center" prop="totalAssetCount" />
      <el-table-column label="资产完好率" align="center" prop="assetIntactRate" />
      <el-table-column
        label="系统创建时间"
        align="center"
        prop="createTimeSys"
