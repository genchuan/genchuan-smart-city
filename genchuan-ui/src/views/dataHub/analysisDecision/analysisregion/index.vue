<template>
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="正常监测部件数" prop="normalMonCompCount">
        <el-input
          v-model="queryParams.normalMonCompCount"
          placeholder="请输入正常监测部件数"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="异常监测部件数" prop="abnMonCompCount">
        <el-input
          v-model="queryParams.abnMonCompCount"
          placeholder="请输入异常监测部件数"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
      ...
      <el-form-item label="监测事件办结率" prop="monEvtCompleteRate">
        <el-input
          v-model="queryParams.monEvtCompleteRate"
          placeholder="请输入监测事件办结率"
          clearable
          @keyup.enter="handleQuery"
          class="!w-240px"
        />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="正常监测部件数" align="center" prop="normalMonCompCount" />
      <el-table-column label="异常监测部件数" align="center" prop="abnMonCompCount" />
      <el-table-column label="监测事件办结率" align="center" prop="monEvtCompleteRate" />
