    ...
    >
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          ...
          <el-form-item label="所属指标分类ID" prop="idxCatId">
            <el-input
              v-model="formData.idxCatId"
              placeholder="请输入所属指标分类ID"
              class="rounded-md"
            />
          </el-form-item>
          <el-form-item label="所属指标分类名称" prop="idxCatName">
            <el-input
          ...
          <el-form-item label="指标类型" prop="idxType">
            <el-select v-model="formData.idxType" placeholder="请选择指标类型" class="rounded-md">
        ...
        <el-col :span="12">
          ...
          <el-form-item label="数据来源字段" prop="dataSourceField">
            <el-input
              v-model="formData.dataSourceField"
              placeholder="请输入数据来源字段"
              class="rounded-md"
            />
          </el-form-item>
