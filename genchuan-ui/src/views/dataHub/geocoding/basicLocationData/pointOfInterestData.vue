  ...
  <div class="cc-main">
    <div class="cc-main-content">
      ...
      <div class="cc-title-css">
        ...
        <!--右边的按钮-->
        <div class="right">
          <el-button type="primary" plain :icon="Plus" @click="addClick(titleConfig.addButName)" v-hasPermi="['basicLocationData:pointOfInterestData:create']">
      ...
      <div class="cc-search-css" ref="searchRef">
        ...
        >
          <el-form-item label="名称" prop="poiName">
            <el-input v-model="searchForm.poiName" placeholder="请输入名称" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="标识码" prop="poiCode">
            <el-input v-model="searchForm.poiCode" placeholder="请输入标识码" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="内部编码" prop="intraCode">
            <el-input v-model="searchForm.intraCode" placeholder="请输入内部编码" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          ...
          <el-form-item label="所在层" prop="floor">
            <el-input v-model="searchForm.floor" placeholder="请输入所在层" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="所属类型" prop="poiType">
            <el-select v-model="searchForm.poiType" placeholder="请选择所属类型" class="!w-240px" clearable @change="searchClick">
              <el-option v-for="(item,key) in OptionsAll.poiTypeOptions" :key="key" :label="item.label" :value="item.value"/>
            </el-select>
          </el-form-item>
          <el-form-item>
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column label="名称" min-width="150" align="center" prop="poiName" :show-overflow-tooltip="true" v-if="tableColumnShow('名称')">
            <template #default="scope">
              <div @click="tableOneClick(scope.row)" class="table-active">{{ scope.row.poiName }}</div>
            </template>
          </el-table-column>
          <el-table-column label="标识码" min-width="150" align="center" prop="poiCode" :show-overflow-tooltip="true" v-if="tableColumnShow('标识码')"/>
          <el-table-column label="内部编码" min-width="150" align="center" prop="intraCode" :show-overflow-tooltip="true" v-if="tableColumnShow('内部编码')"/>
          ...
          <el-table-column label="所在层" min-width="150" align="center" prop="floor" :show-overflow-tooltip="true" v-if="tableColumnShow('所在层')"/>
          <el-table-column label="所属类型" min-width="150" align="center" :show-overflow-tooltip="true" v-if="tableColumnShow('所属类型')">
            <template #default="scope">
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button type="success" :icon="View" :plain="true" @click="queryClick(scope.row)" v-hasPermi="['basicLocationData:pointOfInterestData:query']">详细</el-button>
              <el-button type="primary" :icon="EditPen" :plain="true" @click="editClick(scope.row)" v-hasPermi="['basicLocationData:pointOfInterestData:update']">编辑</el-button>
              <el-button type="danger" :icon="Delete" :plain="true" @click="delClick(scope.row)" v-hasPermi="['basicLocationData:pointOfInterestData:delete']">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!--分页-->
            ...
            <template v-if="drawerConfig.active==1">
              ...
              <div class="see-content" v-loading="drawerConfig.loading" v-if="drawerConfig.type === 'query'">
                <ul>
                  ...
                  <li class="width50"><span>所属类型：</span>{{ handleTypeOptions(queryData.poiType, OptionsAll.poiTypeOptions) }}</li>
              ...
              <div class="edit-content" v-loading="drawerConfig.loading" v-else>
                <el-form :model="formData" ref="drawerFromRef" class="edit-content-form" label-width="140px">
                  <el-form-item label="名称：" prop="poiName" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入名称" v-model="formData.poiName" clearable/>
                  </el-form-item>
                  <el-form-item label="标识码：" prop="poiCode" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入标识码" v-model="formData.poiCode" clearable/>
                  </el-form-item>
                  <el-form-item label="内部编码：" prop="intraCode" class="edit-content-form-li width50" :rules="[]">
                  ...
                  <el-form-item label="所在层：" prop="floor" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入所在层" v-model="formData.floor" clearable/>
                  </el-form-item>
                  <el-form-item label="所属类型：" prop="poiType" class="edit-content-form-li width50" :rules="[]">
                    <el-select placeholder="请选择所属类型" v-model="formData.poiType" filterable clearable>
                      <el-option v-for="item in OptionsAll.poiTypeOptions" :key="item.value" :label="item.label" :value="item.value"/>
                    </el-select>
                  </el-form-item>
