  ...
  <div class="cc-main">
    <div class="cc-main-content">
      ...
      <div class="cc-title-css">
        ...
        <!--右边的按钮-->
        <div class="right">
          <el-button type="primary" plain :icon="Plus" @click="addClick(titleConfig.addButName)" v-hasPermi="['basicLocationData:regionalData:create']">
      ...
      <div class="cc-search-css" ref="searchRef">
        ...
        >
          <el-form-item label="名称" prop="regionName">
            <el-input v-model="searchForm.regionName" placeholder="请输入名称" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="标识码" prop="regionCode">
            <el-input v-model="searchForm.regionCode" placeholder="请输入标识码" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          ...
          <el-form-item label="行政区域代码" prop="parentRegionCode">
            <el-input v-model="searchForm.parentRegionCode" placeholder="请输入行政区域代码" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="街道代码" prop="streetCode">
            <el-input v-model="searchForm.streetCode" placeholder="请输入街道代码" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item>
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column label="名称" min-width="150" align="center" prop="regionName" :show-overflow-tooltip="true" v-if="tableColumnShow('名称')">
            <template #default="scope">
              <div @click="tableOneClick(scope.row)" class="table-active">{{ scope.row.regionName }}</div>
            </template>
          </el-table-column>
          <el-table-column label="标识码" min-width="150" align="center" prop="regionCode" :show-overflow-tooltip="true" v-if="tableColumnShow('标识码')"/>
          ...
          <el-table-column label="边界描述" min-width="150" align="center" prop="boundaryDesc" :show-overflow-tooltip="true" v-if="tableColumnShow('边界描述')"/>
          <el-table-column label="行政区域代码" min-width="150" align="center" prop="parentRegionCode" :show-overflow-tooltip="true" v-if="tableColumnShow('行政区域代码')"/>
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button type="success" :icon="View" :plain="true" @click="queryClick(scope.row)" v-hasPermi="['basicLocationData:regionalData:query']">详细</el-button>
              <el-button type="primary" :icon="EditPen" :plain="true" @click="editClick(scope.row)" v-hasPermi="['basicLocationData:regionalData:update']">编辑</el-button>
              <el-button type="danger" :icon="Delete" :plain="true" @click="delClick(scope.row)" v-hasPermi="['basicLocationData:regionalData:delete']">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!--分页-->
            ...
            <template v-if="drawerConfig.active==1">
              ...
              <div class="see-content" v-loading="drawerConfig.loading" v-if="drawerConfig.type === 'query'">
                <ul>
                  ...
                  <li class="width50"><span>行政区域代码：</span>{{ queryData.parentRegionCode }}</li>
              ...
              <div class="edit-content" v-loading="drawerConfig.loading" v-else>
                <el-form :model="formData" ref="drawerFromRef" class="edit-content-form" label-width="140px">
                  <el-form-item label="名称：" prop="regionName" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入名称" v-model="formData.regionName" clearable/>
                  </el-form-item>
                  <el-form-item label="标识码：" prop="regionCode" class="edit-content-form-li width50" :rules="[]">
                  ...
                  <el-form-item label="边界描述：" prop="boundaryDesc" class="edit-content-form-li width100" :rules="[]">
                    <el-input placeholder="请输入边界描述" v-model="formData.boundaryDesc" type="textarea" :autosize="{ minRows: 2, maxRows: 6}" clearable/>
                  </el-form-item>
                  <el-form-item label="行政区域代码：" prop="parentRegionCode" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入行政区域代码" v-model="formData.parentRegionCode" clearable/>
                  </el-form-item>
