  ...
  <div class="cc-main">
    <div class="cc-main-content">
      ...
      <div class="cc-title-css">
        ...
        <!--右边的按钮-->
        <div class="right">
          <el-button type="primary" plain :icon="Plus" @click="addClick(titleConfig.addButName)" v-hasPermi="['baseConfiguration:layerCodeConfiguration:create']">
      ...
      <div class="cc-search-css" ref="searchRef">
        ...
        >
          <el-form-item label="图层代码" prop="layerCode">
            <el-input v-model="searchForm.layerCode" placeholder="请输入图层代码" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="图层名称" prop="layerName">
            <el-input v-model="searchForm.layerName" placeholder="请输入图层名称" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column label="图层代码" min-width="150" align="center" prop="layerCode" :show-overflow-tooltip="true" v-if="tableColumnShow('图层代码')">
            <template #default="scope">
              <div @click="tableOneClick(scope.row)" class="table-active">{{ scope.row.layerCode }}</div>
            </template>
          </el-table-column>
          <el-table-column label="图层名称" min-width="150" align="center" prop="layerName" :show-overflow-tooltip="true" v-if="tableColumnShow('图层名称')"/>
          ...
          <el-table-column label="图层说明" min-width="150" align="center" prop="layerDesc" :show-overflow-tooltip="true" v-if="tableColumnShow('图层说明')"/>
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button type="success" :icon="View" :plain="true" @click="queryClick(scope.row)" v-hasPermi="['baseConfiguration:layerCodeConfiguration:query']">详细</el-button>
              <el-button type="primary" :icon="EditPen" :plain="true" @click="editClick(scope.row)" v-hasPermi="['baseConfiguration:layerCodeConfiguration:update']">编辑</el-button>
              <el-button type="danger" :icon="Delete" :plain="true" @click="delClick(scope.row)" v-hasPermi="['baseConfiguration:layerCodeConfiguration:delete']">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!--分页-->
            ...
            <template v-if="drawerConfig.active==1">
              ...
              <div class="edit-content" v-loading="drawerConfig.loading" v-else>
                <el-form :model="formData" ref="drawerFromRef" class="edit-content-form" label-width="140px">
                  <el-form-item label="图层代码：" prop="layerCode" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入图层代码" v-model="formData.layerCode" clearable/>
                  </el-form-item>
                  <el-form-item label="图层名称：" prop="layerName" class="edit-content-form-li width50" :rules="[]">
                  ...
                  <el-form-item label="图层说明：" prop="layerDesc" class="edit-content-form-li width100" :rules="[]">
                    <el-input placeholder="请输入图层说明" v-model="formData.layerDesc" type="textarea" :autosize="{ minRows: 2, maxRows: 6}" clearable/>
                  </el-form-item>
                </el-form>
              </div>
            </template>
