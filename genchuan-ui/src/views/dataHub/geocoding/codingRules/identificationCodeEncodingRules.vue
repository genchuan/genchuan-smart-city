    ...
    <div class="cc-main-content">
      ...
      <div class="cc-search-css" ref="searchRef">
        ...
        >
          <el-form-item label="规则名称" prop="ruleName">
            <el-input v-model="searchForm.ruleName" placeholder="请输入规则名称" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="县级行政代码位数" prop="adminCodeLength">
            <el-input v-model="searchForm.adminCodeLength" placeholder="请输入县级行政代码位数" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="街道代码位数" prop="streetCodeLength">
            <el-input v-model="searchForm.streetCodeLength" placeholder="请输入街道代码位数" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="图层代码位数" prop="layerCodeLength">
            <el-input v-model="searchForm.layerCodeLength" placeholder="请输入图层代码位数" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="顺序码位数" prop="seqCodeLength">
            <el-input v-model="searchForm.seqCodeLength" placeholder="请输入顺序码位数" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
          <el-form-item label="顺序码生成规则" prop="seqGenRule">
            <el-input v-model="searchForm.seqGenRule" placeholder="请输入顺序码生成规则" clearable class="!w-240px" @change="searchClick"/>
          </el-form-item>
      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column label="规则名称" min-width="150" align="center" prop="ruleName" :show-overflow-tooltip="true" v-if="tableColumnShow('规则名称')">
            <template #default="scope">
              <div @click="tableOneClick(scope.row)" class="table-active">{{ scope.row.ruleName }}</div>
            </template>
          </el-table-column>
          <el-table-column label="县级行政代码位数" min-width="150" align="center" prop="adminCodeLength" :show-overflow-tooltip="true" v-if="tableColumnShow('县级行政代码位数')"/>
          <el-table-column label="街道代码位数" min-width="150" align="center" prop="streetCodeLength" :show-overflow-tooltip="true" v-if="tableColumnShow('街道代码位数')"/>
          <el-table-column label="图层代码位数" min-width="150" align="center" prop="layerCodeLength" :show-overflow-tooltip="true" v-if="tableColumnShow('图层代码位数')"/>
          <el-table-column label="顺序码位数" min-width="150" align="center" prop="seqCodeLength" :show-overflow-tooltip="true" v-if="tableColumnShow('顺序码位数')"/>
          <el-table-column label="顺序码生成规则" min-width="150" align="center" prop="seqGenRule" :show-overflow-tooltip="true" v-if="tableColumnShow('顺序码生成规则')"/>
          ...
          <el-table-column width="300" fixed="right" label="操作" align="center">
            <template #default="scope">
              <el-button type="success" :icon="View" :plain="true" @click="queryClick(scope.row)" v-hasPermi="['codingRules:identificationCodeEncodingRules:query']">详细</el-button>
              <el-button type="primary" :icon="EditPen" :plain="true" @click="editClick(scope.row)" v-hasPermi="['codingRules:identificationCodeEncodingRules:update']">编辑</el-button>
              <el-button type="danger" :icon="Delete" :plain="true" @click="delClick(scope.row)" v-hasPermi="['codingRules:identificationCodeEncodingRules:delete']">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!--分页-->
            ...
            <template v-if="drawerConfig.active==1">
              ...
              <div class="see-content" v-loading="drawerConfig.loading" v-if="drawerConfig.type === 'query'">
                <ul>
                  ...
                  <li class="width50"><span>县级行政代码位数：</span>{{ queryData.adminCodeLength }}</li>
                  <li class="width50"><span>街道代码位数：</span>{{ queryData.streetCodeLength }}</li>
                  <li class="width50"><span>图层代码位数：</span>{{ queryData.layerCodeLength }}</li>
              ...
              <div class="edit-content" v-loading="drawerConfig.loading" v-else>
                <el-form :model="formData" ref="drawerFromRef" class="edit-content-form" label-width="140px">
                  <el-form-item label="规则名称：" prop="ruleName" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入规则名称" v-model="formData.ruleName" clearable/>
                  </el-form-item>
                  <el-form-item label="县级行政代码位数：" prop="adminCodeLength" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入县级行政代码位数" v-model="formData.adminCodeLength" clearable/>
                  </el-form-item>
                  <el-form-item label="街道代码位数：" prop="streetCodeLength" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入街道代码位数" v-model="formData.streetCodeLength" clearable/>
                  </el-form-item>
                  <el-form-item label="图层代码位数：" prop="layerCodeLength" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入图层代码位数" v-model="formData.layerCodeLength" clearable/>
                  </el-form-item>
                  <el-form-item label="顺序码位数：" prop="seqCodeLength" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入顺序码位数" v-model="formData.seqCodeLength" clearable/>
                  </el-form-item>
                  <el-form-item label="顺序码生成规则：" prop="seqGenRule" class="edit-content-form-li width50" :rules="[]">
                    <el-input placeholder="请输入顺序码生成规则" v-model="formData.seqGenRule" clearable/>
                  </el-form-item>
