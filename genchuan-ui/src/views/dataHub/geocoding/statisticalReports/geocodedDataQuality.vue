      ...
      <div class="cc-table-css">
        ...
        >
          ...
          <el-table-column label="统计周期" min-width="150" align="center" prop="statCycle" :show-overflow-tooltip="true" v-if="tableColumnShow('统计周期')">
            ...
            <el-table-column label="检查数据总量" min-width="150" align="center" prop="totalCheckCount" :show-overflow-tooltip="true" v-if="tableColumnShow('检查数据总量')"/>
            <el-table-column label="属性错误数据数量" min-width="150" align="center" prop="attributeErrorCount" :show-overflow-tooltip="true" v-if="tableColumnShow('属性错误数据数量')"/>
            <el-table-column label="位置精度不合格数据数量" min-width="150" align="center" prop="positionErrorCount" :show-overflow-tooltip="true" v-if="tableColumnShow('位置精度不合格数据数量')"/>
            <el-table-column label="未及时更新数据数量" min-width="150" align="center" prop="updateDelayedCount" :show-overflow-tooltip="true" v-if="tableColumnShow('未及时更新数据数量')"/>
            <el-table-column label="质量整改建议" min-width="150" align="center" prop="qualityImprovementSuggestion" :show-overflow-tooltip="true" v-if="tableColumnShow('质量整改建议')"/>
            ...
            <template #default="scope">
              <el-button type="success" :icon="View" :plain="true" @click="queryClick(scope.row)" v-hasPermi="['statisticalReports:geocodedDataQuality:query']">详细</el-button>
      ...
      <el-drawer :title="drawerConfig.title" v-model="drawerConfig.isDrawer" direction="rtl" :modal="false" class="cc-drawer-css" size="100%">
        ...
        <div class="drawer-content">
          ...
          <template v-if="drawerConfig.active==1">
            ...
            <li class="width50"><span>检查数据总量：</span>{{ queryData.totalCheckCount }}</li>
            <li class="width50"><span>属性错误数据数量：</span>{{ queryData.attributeErrorCount }}</li>
            <li class="width50"><span>位置精度不合格数据数量：</span>{{ queryData.positionErrorCount }}</li>
            <li class="width50"><span>未及时更新数据数量：</span>{{ queryData.updateDelayedCount }}</li>
            <li class="width50"><span>质量整改建议：</span>{{ queryData.qualityImprovementSuggestion }}</li>
...
<el-form-item label="检查数据总量：" prop="totalCheckCount" class="edit-content-form-li width50" :rules="[]">
                  <el-input placeholder="请输入检查数据总量" v-model="formData.totalCheckCount" clearable/>
                </el-form-item>
<el-form-item label="属性错误数据数量：" prop="attributeErrorCount" class="edit-content-form-li width50" :rules="[]">
                  <el-input placeholder="请输入属性错误数据数量" v-model="formData.attributeErrorCount" clearable/>
                </el-form-item>
<el-form-item label="位置精度不合格数据数量：" prop="positionErrorCount" class="edit-content-form-li width50" :rules="[]">
                  <el-input placeholder="请输入位置精度不合格数据数量" v-model="formData.positionErrorCount" clearable/>
                </el-form-item>
<el-form-item label="未及时更新数据数量：" prop="updateDelayedCount" class="edit-content-form-li width50" :rules="[]">
                  <el-input placeholder="请输入未及时更新数据数量" v-model="formData.updateDelayedCount" clearable/>
                </el-form-item>
<el-form-item label="质量整改建议：" prop="qualityImprovementSuggestion" class="edit-content-form-li width50" :rules="[]">
                  <el-input placeholder="请输入质量整改建议" v-model="formData.qualityImprovementSuggestion" clearable/>
                </el-form-item>
