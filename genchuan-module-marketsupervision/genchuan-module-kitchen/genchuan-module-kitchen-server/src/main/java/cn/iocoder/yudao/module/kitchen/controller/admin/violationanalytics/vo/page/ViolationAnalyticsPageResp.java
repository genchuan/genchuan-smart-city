...
public class ViolationAnalyticsPageResp {
    ...
    @ExcelProperty(value = "企业违规排名", index = 0)
    @Schema(description = "企业违规频次排名（降序）")
    private Integer rank;
    // ====================== 统计维度（日/周/月） ======================
//    @ExcelProperty(value = "统计时间维度", index = 1)
    @ExcelIgnore
    @Schema(description = "统计时间维度：日、周、月",hidden = true)
    private String statisticPeriod;



    @ExcelProperty(value = "统计时间标识", index = 1)
