...
public class RectifyNoticeServiceImpl implements RectifyNoticeService {
    ...
    public Long createRectifyNotice(@Valid RectifyNoticeSaveReqVO createReqVO) {
        ...
        //生成模版req
        notice.setNoticeContent(buildNoticeContent(notice));
...
//        11111
     ...
     */
    private String buildNoticeContent(RectifyNoticeDO reqVO) {

        LocalDateTime issueTime = reqVO.getIssueTime();
        LocalDate deadline = reqVO.getRectifyDeadline();
...
//     * 生成整改通知书HTML
//     */
//    private String buildNoticeContent(RectifyNoticeSaveReqVO reqVO) {
//
//        int year = reqVO.getIssueTime().getYear();
//
//        String html = """
//        <h2 style="text-align:center">市场监督管理局</h2>
...
//                year,
//                reqVO.getNoticeCode(),
//                reqVO.getRectifyDeadline(),
//                reqVO.getIssueTime().toLocalDate()
//        );
//
//        return html;
//    }
