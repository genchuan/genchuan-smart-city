package cn.iocoder.yudao.module.kitchen.controller.admin.rectifyreview.vo.upload;
...
@Data
public class UploadEvidenceFileReqVO {

    @Schema(description = "[整改复审台账ID]", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotNull(message = "整改复审台账ID不允许为空")
