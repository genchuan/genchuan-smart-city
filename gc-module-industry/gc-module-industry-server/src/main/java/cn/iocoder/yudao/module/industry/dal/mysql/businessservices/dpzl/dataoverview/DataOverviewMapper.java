...
public interface DataOverviewMapper {
     ...
     * 获取区域企业分布
     */
    List<DataOverviewRespVO.RegionEntDistribution> selectRegionEntDistribution();

    /**
     * 获取近7天办件趋势
     */
    List<DataOverviewRespVO.DailyHandleTrend> selectDailyHandleTrend(@Param("beginDate") String beginDate,
