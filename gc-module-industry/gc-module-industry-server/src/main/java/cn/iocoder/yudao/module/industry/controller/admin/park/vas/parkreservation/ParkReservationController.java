package cn.iocoder.yudao.module.industry.controller.admin.park.vas.parkreservation;

import cn.iocoder.yudao.module.industry.controller.admin.park.vas.parkreservation.vo.ParkReservationPageReqVO;
import cn.iocoder.yudao.module.industry.controller.admin.park.vas.parkreservation.vo.ParkReservationRespVO;
...
import cn.iocoder.yudao.module.industry.service.park.vas.parkreservation.ParkReservationService;
...
public class ParkReservationController {
    ...
    @Operation(summary = "导出停车预约 Excel")
    ...
    public void exportParkReservationExcel(@Valid ParkReservationPageReqVO pageReqVO,
        ...
        // 导出 Excel
        ExcelUtils.write(response, "停车预约.xls", "数据", ParkReservationRespVO.class,
